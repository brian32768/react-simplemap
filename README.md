...
I have no idea what "test" does right now. Maybe nothing at all. Probably killed it
when I deleted config/. It looks like it uses [jest](https://jestjs.io) which I should look at!
